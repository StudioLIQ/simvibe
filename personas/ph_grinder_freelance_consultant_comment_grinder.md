# Persona: Yuki Kowalski (`ph_grinder_freelance_consultant_comment_grinder`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_freelance_consultant_comment_grinder`
...
- **Monthly income (gross):** $6,637–$13,797
...
- **Daily tools:** Slack, Google Workspace, Notion, Zoom, Chrome, Mailchimp, Google Ads, GA4
