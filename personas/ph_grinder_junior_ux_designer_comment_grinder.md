# Persona: Liam Reyes (`ph_grinder_junior_ux_designer_comment_grinder`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_junior_ux_designer_comment_grinder`
- **Display name:** Liam Reyes
...
- **Monthly income (gross):** $8,119–$10,909
...
- **Alternatives they already use:** LottieFiles, Webflow, Canva, Figma, Framer
