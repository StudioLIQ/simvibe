# Persona: Iris Sato (`ph_grinder_framer_designer_comment_grinder`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_framer_designer_comment_grinder`
...
- **Monthly income (gross):** $8,628–$10,363
...
- **Alternatives they already use:** Webflow, LottieFiles, Framer, Figma, Canva
