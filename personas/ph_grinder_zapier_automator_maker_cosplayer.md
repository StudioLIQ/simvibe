# Persona: Fatima Cohen (`ph_grinder_zapier_automator_maker_cosplayer`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_zapier_automator_maker_cosplayer`
...
- **Monthly income (gross):** $6,191–$10,044
...
- **Alternatives they already use:** Zapier, Airtable, Notion, Google Sheets, Calendly
