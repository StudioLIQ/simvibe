# Persona: Riley Santos (`low_exposure_education_it_admin_time_poor`)

## 0) Identity
- **Persona ID (snake_case):** `low_exposure_education_it_admin_time_poor`
...
- **Company size:** 2,000+ staff (IT org ~36)
- **Team:** Cross-functional team, collaborates with 3–6 stakeholders weekly
- **Monthly income (gross):** $8,885–$10,640
...
- **Daily tools:** Slack, Google Workspace, Notion, Zoom, Chrome, Jamf, Intune, ServiceNow
