# Persona: Fatima Chen (`everyday_low_exposure_learning_coordinator_time_poor`)

## 0) Identity
- **Persona ID (snake_case):** `everyday_low_exposure_learning_coordinator_time_poor`
...
- **Monthly income (gross):** $5,847–$8,624
