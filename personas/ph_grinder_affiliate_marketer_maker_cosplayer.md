# Persona: Tariq Santos (`ph_grinder_affiliate_marketer_maker_cosplayer`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_affiliate_marketer_maker_cosplayer`
...
- **Company size:** 12779+ people
- **Team:** Cross-functional team, collaborates with 3–6 stakeholders weekly
- **Monthly income (gross):** $6,674–$14,708
...
- **Alternatives they already use:** Airtable, Zapier, Calendly, Google Sheets, Notion
