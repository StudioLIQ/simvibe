# Persona: Sam Nguyen (`ph_grinder_student_builder_comment_grinder`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_student_builder_comment_grinder`
...
- **Monthly income (gross):** $4,374–$8,524
