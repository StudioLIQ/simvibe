# Persona: Chloe Johnson (`ph_grinder_shopify_operator_comment_grinder`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_shopify_operator_comment_grinder`
...
- **Monthly income (gross):** $5,754–$8,524
...
- **Alternatives they already use:** Notion, Google Sheets, Zapier, Airtable, Calendly
