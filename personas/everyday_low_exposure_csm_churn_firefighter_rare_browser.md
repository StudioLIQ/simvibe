# Persona: Noah Petrova (`everyday_low_exposure_csm_churn_firefighter_rare_browser`)

## 0) Identity
- **Persona ID (snake_case):** `everyday_low_exposure_csm_churn_firefighter_rare_browser`
