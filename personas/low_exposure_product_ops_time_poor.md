# Persona: Sana Ibrahim (`low_exposure_product_ops_time_poor`)

## 0) Identity
- **Persona ID (snake_case):** `low_exposure_product_ops_time_poor`
...
- **Monthly income (gross):** $9,241–$19,313
...
- **Daily tools:** Slack, Google Workspace, Notion, Zoom, Chrome, Figma, Hotjar, Amplitude
...
- **Alternatives they already use:** Amplitude, Mixpanel, Notion, Linear, Intercom
