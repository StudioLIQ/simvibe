# Persona: Linh Lee (`ph_grinder_exec_assistant_maker_cosplayer`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_exec_assistant_maker_cosplayer`
...
- **Monthly income (gross):** $8,055–$10,653
...
- **Alternatives they already use:** Airtable, Notion, Calendly, Zapier, Google Sheets
