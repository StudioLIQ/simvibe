# Persona: Mina Tanaka (`ph_grinder_project_coordinator_maker_cosplayer`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_project_coordinator_maker_cosplayer`
...
- **Company size:** 419 people
- **Team:** Cross-functional team, collaborates with 3–6 stakeholders weekly
- **Monthly income (gross):** $7,628–$8,824
...
- **Alternatives they already use:** Calendly, Google Sheets, Airtable, Zapier, Notion
