# Persona: Ben Dubois (`ph_grinder_no_code_builder_maker_cosplayer`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_no_code_builder_maker_cosplayer`
...
- **Company size:** 73 people
- **Team:** Cross-functional team, collaborates with 3–6 stakeholders weekly
- **Monthly income (gross):** $6,869–$10,638
...
- **Alternatives they already use:** Google Sheets, Notion, Zapier, Airtable, Calendly
