# Persona: Ava Stein (`ph_grinder_small_business_owner_comment_grinder`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_small_business_owner_comment_grinder`
...
- **Company size:** 10268+ people
- **Team:** Cross-functional team, collaborates with 3–6 stakeholders weekly
- **Monthly income (gross):** $6,400–$8,663
