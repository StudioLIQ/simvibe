# Persona: Nora Singh (`ph_grinder_ltd_deal_hunter_maker_cosplayer`)
...
- **Monthly income (gross):** $4,641–$6,241
...
- **Alternatives they already use:** Google Sheets, Calendly, Zapier, Notion, Airtable
