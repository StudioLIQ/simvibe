# Persona: Vivian Martinez (`ph_grinder_pmm_associate_comment_grinder`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_pmm_associate_comment_grinder`
...
- **Monthly income (gross):** $5,014–$9,638
...
- **Daily tools:** Slack, Google Workspace, Notion, Zoom, Chrome, Meta Ads Manager, Mailchimp, Webflow
...
- **Alternatives they already use:** Ahrefs, GA4, HubSpot, Hootsuite, Mailchimp
