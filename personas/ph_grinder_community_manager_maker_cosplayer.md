# Persona: Zara Dubois (`ph_grinder_community_manager_maker_cosplayer`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_community_manager_maker_cosplayer`
...
- **Monthly income (gross):** $4,793–$9,963
...
- **Alternatives they already use:** Intercom, Help Scout, Zendesk, Jira, Freshdesk
