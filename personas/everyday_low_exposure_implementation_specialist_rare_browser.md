# Persona: Maya Davis (`everyday_low_exposure_implementation_specialist_rare_browser`)

## 0) Identity
- **Persona ID (snake_case):** `everyday_low_exposure_implementation_specialist_rare_browser`
...
- **Company size:** 459 people
- **Team:** Cross-functional team, collaborates with 3–6 stakeholders weekly
- **Monthly income (gross):** $6,910–$10,066
...
- **Alternatives they already use:** Zapier, Notion, Airtable, Google Sheets, Calendly
