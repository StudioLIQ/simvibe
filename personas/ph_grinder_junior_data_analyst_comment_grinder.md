# Persona: Quinn Nguyen (`ph_grinder_junior_data_analyst_comment_grinder`)
...
- **Monthly income (gross):** $7,062–$14,677
...
- **Daily tools:** Slack, Google Workspace, Notion, Zoom, Chrome, Mode, Snowflake, BigQuery
...
- **Alternatives they already use:** dbt, Tableau, Looker, Mode, Metabase
