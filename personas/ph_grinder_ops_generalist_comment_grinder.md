# Persona: Kai Reyes (`ph_grinder_ops_generalist_comment_grinder`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_ops_generalist_comment_grinder`
...
- **Company size:** 2406+ people
- **Team:** Cross-functional team, collaborates with 3–6 stakeholders weekly
- **Monthly income (gross):** $9,253–$11,091
