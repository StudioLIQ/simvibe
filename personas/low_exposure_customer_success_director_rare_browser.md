# Persona: Kai Reyes (`low_exposure_customer_success_director_rare_browser`)

## 0) Identity
- **Persona ID (snake_case):** `low_exposure_customer_success_director_rare_browser`
...
- **Alternatives they already use:** Intercom, Zendesk, Help Scout, Freshdesk, Jira
