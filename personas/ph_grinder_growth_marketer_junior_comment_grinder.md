# Persona: Noah Petrova (`ph_grinder_growth_marketer_junior_comment_grinder`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_growth_marketer_junior_comment_grinder`
- **Display name:** Noah Petrova
...
- **Monthly income (gross):** $7,177–$12,719
...
- **Daily tools:** Slack, Google Workspace, Notion, Zoom, Chrome, Mailchimp, Meta Ads Manager, HubSpot
