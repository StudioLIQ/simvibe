# Persona: Quinn Olsen (`ph_grinder_content_marketer_general_comment_grinder`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_content_marketer_general_comment_grinder`
...
- **Monthly income (gross):** $8,151–$9,273
...
- **Daily tools:** Slack, Google Workspace, Notion, Zoom, Chrome, HubSpot, Webflow, Google Ads
...
- **Alternatives they already use:** HubSpot, Mailchimp, GA4, Hootsuite, Ahrefs
