# Persona: Tessa Brown (`low_exposure_program_manager_enterprise_rare_browser`)

## 0) Identity
- **Persona ID (snake_case):** `low_exposure_program_manager_enterprise_rare_browser`
...
- **Company size:** 5036+ people
- **Team:** Cross-functional team, collaborates with 3–6 stakeholders weekly
- **Monthly income (gross):** $7,026–$11,556
...
- **Alternatives they already use:** Airtable, Notion, Google Sheets, Zapier, Calendly
