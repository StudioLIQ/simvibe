# Persona: Tariq Ramirez (`ph_grinder_it_helpdesk_tech_maker_cosplayer`)

## 0) Identity
- **Persona ID (snake_case):** `ph_grinder_it_helpdesk_tech_maker_cosplayer`
...
- **Monthly income (gross):** $5,207–$12,479
...
- **Daily tools:** Slack, Google Workspace, Notion, Zoom, Chrome, Okta, ServiceNow, Jamf
...
- **Alternatives they already use:** Intune, Jamf, Okta, ServiceNow, Google Admin
