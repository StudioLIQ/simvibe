# LOE-016 (P1) Persona: Mina Lee (`low_exposure_ml_engineer_prod_time_poor`)

- Status: [x] Done
- Output: `personas/low_exposure_ml_engineer_prod_time_poor.md`
...
## Completion Notes
- Generated `personas/low_exposure_ml_engineer_prod_time_poor.md` via `scripts/generate-personas.mjs`
