# LOE-058 (P1) Persona: Tariq Haddad (`low_exposure_finance_controller_time_poor`)

- Status: [x] Done
- Output: `personas/low_exposure_finance_controller_time_poor.md`
...
- Cares about predictable pricing, invoicing, and clean cancellation terms.
- Will not book a call; needs a self-serve trial or a crisp demo. Bounce trigger: long onboarding or vague “AI” claims.

## Deliverables
- Create `personas/low_exposure_finance_controller_time_poor.md`
- Fill **all** sections 0-10 from `PERSONA.md` with concrete detail (no placeholders)

## Acceptance Criteria
- `personas/low_exposure_finance_controller_time_poor.md` exists
...
## Completion Notes
- Generated `personas/low_exposure_finance_controller_time_poor.md` via `scripts/generate-personas.mjs`
