# LOE-062 (P1) Persona: Wen Dubois (`low_exposure_legal_counsel_privacy_time_poor`)

- Status: [x] Done
- Output: `personas/low_exposure_legal_counsel_privacy_time_poor.md`
...
## Deliverables
- Create `personas/low_exposure_legal_counsel_privacy_time_poor.md`
- Fill **all** sections 0-10 from `PERSONA.md` with concrete detail (no placeholders)

## Acceptance Criteria
- `personas/low_exposure_legal_counsel_privacy_time_poor.md` exists
...
## Completion Notes
- Generated `personas/low_exposure_legal_counsel_privacy_time_poor.md` via `scripts/generate-personas.mjs`
