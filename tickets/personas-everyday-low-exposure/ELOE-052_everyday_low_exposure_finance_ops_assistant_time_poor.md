# ELOE-052 (P1) Persona: Priya Singh (`everyday_low_exposure_finance_ops_assistant_time_poor`)

- Status: [x] Done
- Output: `personas/everyday_low_exposure_finance_ops_assistant_time_poor.md`
...
## Deliverables
- Create `personas/everyday_low_exposure_finance_ops_assistant_time_poor.md`
- Fill **all** sections 0-10 from `PERSONA.md` with concrete detail (no placeholders)

## Acceptance Criteria
- `personas/everyday_low_exposure_finance_ops_assistant_time_poor.md` exists
...
## Completion Notes
- Generated `personas/everyday_low_exposure_finance_ops_assistant_time_poor.md` via `scripts/generate-personas.mjs`
